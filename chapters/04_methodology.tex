...
The \textbf{Drive \& Act} dataset comprises 12 hours of video data with 15 participators segmented into 29 lengthy sequences. For each sequence, we aim to generate a unique \textbf{dynamic graph} that temporally represents both the participant's actions and the relationships between objects observed in the video. This process involves several key steps.
